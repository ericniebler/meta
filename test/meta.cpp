...
namespace test_datatype_group
{
    ...
    static_assert(not_<is_trait<nil_>>{}, "");

    // _t, lazy::_t
    static_assert(is_trait<int_<1>>{}, "");
    static_assert(std::is_same<_t<int_<1>>, typename int_<1>::type>{}, "");
    static_assert(std::is_same<_t<lazy::_t<int_<1>>>, typename int_<1>::type>{}, "");
    static_assert(std::is_same<_t<int_<1>>, int_<1>>{}, "");
    static_assert(
        std::is_same<_t<lazy::if_<defer<is_trait, int_<1>>, lazy::_t<int_<1>>, lazy::_t<nil_>>>,
                     lazy::_t<int_<1>>>{},
        "");
    static_assert(std::is_same<_t<lazy::_t<int_<1>>>, int_<1>>{}, "");

    // id, id_t, lazy::id
    static_assert(is_trait<id<int_<1>>>{}, "");
    static_assert(is_callable<id<int_<1>>>{}, "");
    static_assert(std::is_same<_t<id<int_<1>>>, int_<1>>{}, "");
    static_assert(std::is_same<_t<_t<lazy::id<int_<1>>>>, typename int_<1>::type>{}, "");
    static_assert(std::is_same<_t<_t<lazy::id<int_<1>>>>, int_<1>>{}, "");
    static_assert(
        std::is_same<_t<lazy::if_<defer<is_trait, int_<1>>, lazy::id<int_<1>>, lazy::_t<nil_>>>,
                     lazy::id<int_<1>>>{},
        "");
    static_assert(is_trait<id_t<int_<1>>>{}, "");
    static_assert(not_<is_callable<id_t<int_<1>>>>{}, "");
    static_assert(std::is_same<id_t<int_<1>>, int_<1>>{}, "");
    static_assert(std::is_same<id_t<int_<1>>, _t<id<int_<1>>>>{}, "");
    static_assert(std::is_same<id_t<int_<1>>, _t<_t<lazy::id<int_<1>>>>>{}, "");
    ...
    namespace
    {
        ...
        static_assert(std::is_base_of<t1, t3>{}, "");
        static_assert(std::is_base_of<t2, t3>{}, "");

        static_assert(!std::is_base_of<t1, t3_lazy>{}, "");
        static_assert(!std::is_base_of<t2, t3_lazy>{}, "");

        static_assert(std::is_base_of<t1, _t<t3_lazy>>{}, "");
        static_assert(std::is_base_of<t2, _t<t3_lazy>>{}, "");

        // list of inherited types must be unique
        static_assert(std::is_same<inherit<unique<list<t1, t1>>>, inherit<list<t1>>>{}, "");

// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if(!defined(__GNUC__) || __GNUC__ >= 5) || defined(__clang__)
        static_assert(!can_invoke<quote<inherit>, t1, t1>{}, "");
#endif
...
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if(!defined(__GNUC__) || __GNUC__ >= 5) || defined(__clang__)
        static_assert(!can_invoke<quote<inherit>, t1_f>{}, "");
#endif
    } // namespace
    ...
    namespace // test integrals, math
    {
        ...
        static_assert(std::is_same<std::integer_sequence<int, 0, 1, 2>,
                                   meta::make_integer_sequence<int, 3>>{},
                      "");
        static_assert(std::is_same<std::integer_sequence<std::size_t, 0, 1, 2>,
                                   meta::make_index_sequence<3>>{},
                      "");
        static_assert(std::is_same<std::integer_sequence<int, 1, 3, 2>,
                                   meta::integer_sequence<int, 1, 3, 2>>{},
                      "");
        static_assert(std::is_same<std::integer_sequence<std::size_t, 1, 3, 2>,
                                   meta::index_sequence<1, 3, 2>>{},
                      "");
#endif

#if META_CXX_INTEGER_SEQUENCE
        static_assert(std::is_same<as_list<meta::make_index_sequence<3>>,
                                   list<meta::size_t<0>, meta::size_t<1>, meta::size_t<2>>>{},
                      "");
        static_assert(std::is_same<as_list<meta::make_integer_sequence<int, 3>>,
                                   list<int_<0>, int_<1>, int_<2>>>{},
                      "");
#endif

        static_assert(equal_to<std::integral_constant<bool, true>, bool_<true>>{}, "");
        static_assert(equal_to<std::integral_constant<bool, false>, bool_<false>>{}, "");
        static_assert(equal_to<std::integral_constant<char, 'a'>, char_<'a'>>{}, "");
        static_assert(equal_to<std::integral_constant<int, 10>, int_<10>>{}, "");
        static_assert(equal_to<std::integral_constant<std::size_t, 10>, meta::size_t<10>>{}, "");
        static_assert(equal_to<std::integral_constant<int, 10>, int_<10>>{}, "");

        static_assert(42_z == 42, "");

        // Math operations
        static_assert(equal_to<std::integral_constant<int, 2>, inc<int_<1>>>{}, "");

        static_assert(equal_to<std::integral_constant<int, 1>, dec<int_<2>>>{}, "");

        static_assert(equal_to<std::integral_constant<int, 3>, plus<int_<2>, int_<1>>>{}, "");
        static_assert(equal_to<plus<int_<1>, int_<2>>, plus<int_<2>, int_<1>>>{}, "");

        static_assert(equal_to<std::integral_constant<int, 1>, minus<int_<3>, int_<2>>>{}, "");
        static_assert(!equal_to<minus<int_<1>, int_<2>>, minus<int_<2>, int_<1>>>{}, "");

        static_assert(equal_to<std::integral_constant<int, 6>, multiplies<int_<3>, int_<2>>>{}, "");
        static_assert(equal_to<multiplies<int_<3>, int_<2>>, multiplies<int_<2>, int_<3>>>{}, "");

        static_assert(equal_to<std::integral_constant<int, 1>, divides<int_<3>, int_<2>>>{}, "");
        static_assert(!equal_to<divides<int_<1>, int_<2>>, divides<int_<2>, int_<1>>>{}, "");

        static_assert(equal_to<int_<-1>, negate<int_<1>>>{}, "");

        static_assert(equal_to<modulus<int_<10>, int_<2>>, int_<0>>{}, "");
        static_assert(equal_to<modulus<int_<11>, int_<2>>, int_<1>>{}, "");

        static_assert(greater<int_<11>, int_<10>>{}, "");
        static_assert(!greater<int_<11>, int_<11>>{}, "");
        static_assert(!greater<int_<11>, int_<12>>{}, "");

        static_assert(greater_equal<int_<11>, int_<10>>{}, "");
        static_assert(greater_equal<int_<11>, int_<11>>{}, "");
        static_assert(!greater_equal<int_<11>, int_<12>>{}, "");

        static_assert(!less<int_<11>, int_<10>>{}, "");
        static_assert(!less<int_<11>, int_<11>>{}, "");
        static_assert(less<int_<11>, int_<12>>{}, "");

        static_assert(!less_equal<int_<11>, int_<10>>{}, "");
        static_assert(less_equal<int_<11>, int_<11>>{}, "");
        static_assert(less_equal<int_<11>, int_<12>>{}, "");

        static_assert(equal_to<bit_and<int_<10>, int_<15>>, int_<10>>{}, "");
        static_assert(equal_to<bit_and<int_<1>, int_<2>>, int_<0>>{}, "");

        static_assert(equal_to<bit_or<int_<10>, int_<15>>, int_<15>>{}, "");
        static_assert(equal_to<bit_or<int_<1>, int_<2>>, int_<3>>{}, "");

        static_assert(equal_to<bit_xor<int_<1>, int_<1>>, int_<0>>{}, "");
        static_assert(equal_to<bit_xor<int_<10>, int_<15>>, int_<5>>{}, "");

        static_assert(equal_to<bit_not<int_<15>>, int_<-16>>{}, "");
        static_assert(equal_to<bit_not<int_<0>>, int_<-1>>{}, "");

        static_assert(std::is_same<invoke<lambda<_a, lazy::inc<_a>>, int_<1>>, int_<2>>{}, "");
        static_assert(std::is_same<invoke<lambda<_a, lazy::dec<_a>>, int_<2>>, int_<1>>{}, "");
        static_assert(
            std::is_same<invoke<lambda<_a, _b, lazy::plus<_a, _b>>, int_<3>, int_<2>>, int_<5>>{},
            "");
        ...
        static_assert(
            invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>, int_<-1>, lazy::negate<int_<1>>>{}, "");

        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::modulus<int_<10>, int_<2>>, int_<0>>{},
                      "");
        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::modulus<int_<11>, int_<2>>, int_<1>>{},
                      "");

        static_assert(invoke<lambda<_a, _b, lazy::greater<_a, _b>>, int_<11>, int_<10>>{}, "");
        static_assert(!invoke<lambda<_a, _b, lazy::greater<_a, _b>>, int_<11>, int_<11>>{}, "");
        static_assert(!invoke<lambda<_a, _b, lazy::greater<_a, _b>>, int_<11>, int_<12>>{}, "");

        static_assert(invoke<lambda<_a, _b, lazy::greater_equal<_a, _b>>, int_<11>, int_<10>>{},
                      "");
        static_assert(invoke<lambda<_a, _b, lazy::greater_equal<_a, _b>>, int_<11>, int_<11>>{},
                      "");
        static_assert(!invoke<lambda<_a, _b, lazy::greater_equal<_a, _b>>, int_<11>, int_<12>>{},
                      "");

        static_assert(!invoke<lambda<_a, _b, lazy::less<_a, _b>>, int_<11>, int_<10>>{}, "");
        static_assert(!invoke<lambda<_a, _b, lazy::less<_a, _b>>, int_<11>, int_<11>>{}, "");
        static_assert(invoke<lambda<_a, _b, lazy::less<_a, _b>>, int_<11>, int_<12>>{}, "");

        static_assert(!invoke<lambda<_a, _b, lazy::less_equal<_a, _b>>, int_<11>, int_<10>>{}, "");
        static_assert(invoke<lambda<_a, _b, lazy::less_equal<_a, _b>>, int_<11>, int_<11>>{}, "");
        static_assert(invoke<lambda<_a, _b, lazy::less_equal<_a, _b>>, int_<11>, int_<12>>{}, "");

        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::bit_and<int_<10>, int_<15>>, int_<10>>{},
                      "");
        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::bit_and<int_<1>, int_<2>>, int_<0>>{},
                      "");

        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::bit_or<int_<10>, int_<15>>, int_<15>>{},
                      "");
        ...
        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::bit_xor<int_<1>, int_<1>>, int_<0>>{},
                      "");
        static_assert(invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>,
                             lazy::bit_xor<int_<10>, int_<15>>, int_<5>>{},
                      "");

        static_assert(
            invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>, lazy::bit_not<int_<15>>, int_<-16>>{},
            "");
        static_assert(
            invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>, lazy::bit_not<int_<0>>, int_<-1>>{}, "");
    } // namespace

    namespace // test list
    {
        static_assert(!std::is_same<list<int, char, void>, std::tuple<int, char, void>>::value, "");
        static_assert(std::is_same<list<int, char, void>, as_list<std::tuple<int, char, void>>>{},
                      "");
        static_assert(
            std::is_same<as_list<list<int, char, void>>, as_list<std::tuple<int, char, void>>>{},
            "");
        static_assert(list<int, char, void>::size() == size<list<int, char, void>>{}, "");
        static_assert(std::is_same<at_c<list<int, char, void>, 2>, void>{}, "");
        static_assert(std::is_same<at<list<int, char, void>, meta::size_t<0>>, int>{}, "");
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if(!defined(__GNUC__) || __GNUC__ >= 5) || defined(__clang__)
        static_assert(!can_invoke<quote<at>, list<int, char, void>, meta::size_t<3>>{}, "");
#endif
    } // namespace
} // namespace test_datatype_group
...
namespace test_transformations
{
    namespace test_partition
    {
        ...
        static_assert(std::is_same<L2, list<list<char[6], char[10]>,
                                            list<char[5], char[3], char[2], char[1], char[5]>>>{},
                      "");
        ...
        using L4 = list<int_<1>, int_<2>, int_<3>, int_<4>, int_<5>, int_<6>, int_<7>, int_<8>,
                        int_<9>, int_<10>>;
        static_assert(std::is_same<typename is_even::template invoke<int_<2>>, bool_<true>>{}, "");
        static_assert(std::is_same<invoke<not_fn<quote<is_even::invoke>>, int_<2>>, bool_<false>>{},
                      "");
        using L5 = partition<L4, is_even>;
        static_assert(std::is_same<L5, list<list<int_<2>, int_<4>, int_<6>, int_<8>, int_<10>>,
                                            list<int_<1>, int_<3>, int_<5>, int_<7>, int_<9>>>>{},
                      "");
        ...
        static_assert(std::is_same<L7, list<list<char[6], char[10]>,
                                            list<char[5], char[3], char[2], char[1], char[5]>>>{},
                      "");
...
static_assert(std::is_same<reverse<list<int, short, double>>, list<double, short, int>>{}, "");
static_assert(
    std::is_same<reverse<list<int, short, double, float>>, list<float, double, short, int>>{}, "");
static_assert(
    std::is_same<
...
static_assert(can_invoke<meta::quote<std::pair>, int, int>{}, "");
// I'm guessing this failure is due to GCC #64970
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if(!defined(__GNUC__) || __GNUC__ >= 5) || defined(__clang__)
static_assert(!can_invoke<meta::quote<std::pair>, int, int, int>{}, "");
#endif
...
static_assert(can_invoke<lambda<_a, lazy::if_<std::is_integral<_a>, _a>>, int>{}, "");
// I'm guessing this failure is due to GCC #64970
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if(!defined(__GNUC__) || __GNUC__ >= 5) || defined(__clang__)
static_assert(!can_invoke<lambda<_a, lazy::if_<std::is_integral<_a>, _a>>, float>{}, "");
#endif
...
static_assert(std::is_same<invoke<uncvref_fn, int const &>, int>{}, "");

using L = list<int, short, int, float>;
static_assert(std::is_same<find<L, int>, list<int, short, int, float>>{}, "");
static_assert(
    std::is_same<find_if<L, bind_front<quote<std::is_same>, int>>, list<int, short, int, float>>{},
    "");
static_assert(std::is_same<find_if<L, bind_front<quote<std::is_same>, double>>, list<>>{}, "");
static_assert(std::is_same<reverse_find<L, int>, list<int, float>>{}, "");
static_assert(
    std::is_same<reverse_find_if<L, bind_front<quote<std::is_same>, int>>, list<int, float>>{}, "");
static_assert(std::is_same<reverse_find_if<L, bind_front<quote<std::is_same>, double>>, list<>>{},
              "");
...
template <typename N>
struct fact : let<lazy::if_c<(N{} > 0), lazy::multiplies<N, defer<fact, dec<N>>>, meta::size_t<1>>>
{
};
...
int main()
{
    ...
    // meta::for_each
    {
        ...
        static_assert(std::is_same<meta::_t<std::remove_cv<decltype(r)>>, check_integral>{}, "");
    }
    ...
    // pathological lambda test
    {
        ...
        static_assert(std::is_same<X, lambda_test<_a>>{}, "");
    }
    ...
    // meta::in
    {
        static_assert(in<list<int, int, short, float>, int>{}, "");
        static_assert(in<list<int, int, short, float>, short>{}, "");
        static_assert(in<list<int, int, short, float>, float>{}, "");
        static_assert(!in<list<int, int, short, float>, double>{}, "");
    }

    // lambda with variadic placeholders
    {
        using X = invoke<lambda<_args, list<_args>>, int, short, double>;
        static_assert(std::is_same<X, list<int, short, double>>{}, "");

        using X2 = invoke<lambda<_a, lambda_test<_a>>, int>;
        static_assert(std::is_same<X2, lambda_test<_a>>{}, "");

        using Y = invoke<lambda<_args, defer<std::pair, _args>>, int, short>;
        static_assert(std::is_same<Y, std::pair<int, short>>{}, "");

        using Y2 = invoke<lambda<_args, list<_args, list<_args>>>, int, short>;
        static_assert(std::is_same<Y2, list<int, short, list<int, short>>>{}, "");

        using Z = invoke<lambda<_a, _args, list<int, _args, double, _a>>, short *, short, float>;
        static_assert(std::is_same<Z, list<int, short, float, double, short *>>{}, "");
        ...
        using A = invoke<lambda<_a, lazy::invoke<lambda<_b, _args, list<_args, _b>>, _a,
                         ...
                         int>;
        static_assert(std::is_same<A, list<int *, int &, int>>{}, "");
        ...
        using B = invoke<lambda<_a, _args, lazy::invoke<lambda<_b, list<_b, _args, _a>>, _a>>, int,
                         short, double>;
        static_assert(std::is_same<B, list<int, short, double, int>>{}, "");
        ...
        static_assert(
            std::is_same<ZZ, list<short, int, list<float, double>, list<short, float, double>>>{},
            "");

// I'm guessing this failure is due to GCC #64970
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
#if(!defined(__GNUC__) || __GNUC__ >= 5) || defined(__clang__)
        static_assert(!can_invoke<lambda<_args, defer<std::pair, _args>>, int>{}, "");
        static_assert(!can_invoke<lambda<_args, defer<std::pair, _args>>, int, short, double>{},
                      "");
        static_assert(!can_invoke<lambda<_a, defer<std::pair, _a, _a>>, int, short>{}, "");
        static_assert(!can_invoke<lambda<_a, _b, _c, _args, defer<std::pair, _a, _a>>>{}, "");
#endif
    }
