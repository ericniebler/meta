...
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
    ...
    namespace // test integrals, math
    {
        ...
        static_assert(
            std::is_same<invoke<lambda<_a, _b, lazy::plus<_a, _b>>, int_<3>, int_<2>>, int_<5>>::value,
            "");
        ...
        static_assert(
            invoke<lambda<_a, _b, lazy::equal_to<_a, _b>>, lazy::bit_not<int_<15>>, int_<-16>>::value,
            "");
        static_assert(
    ...
    namespace // test list
    {
        ...
        static_assert(std::is_same<list<int, char, void>, as_list<std::tuple<int, char, void>>>::value,
                      "");
        static_assert(
            std::is_same<as_list<list<int, char, void>>, as_list<std::tuple<int, char, void>>>::value,
            "");
...
namespace test_transformations
{
    namespace test_partition
    {
        ...
        static_assert(std::is_same<invoke<not_fn<quote<is_even::invoke>>, int_<2>>, bool_<false>>::value,
                      "");
...
static_assert(
    std::is_same<find_if<L, bind_front<quote<std::is_same>, int>>, list<int, short, int, float>>::value,
    "");
...
int main()
{
    ...
    // lambda with variadic placeholders
    {
        ...
        static_assert(
            std::is_same<ZZ, list<short, int, list<float, double>, list<short, float, double>>>::value,
            "");
...
// https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64970
    ...
    // Test for meta::sort
    {
        ...
        static_assert(
            std::is_same<L2,
                         list<char[1], char[2], char[3], char[5], char[5], char[6], char[10]>>::value,
            "");
    }
